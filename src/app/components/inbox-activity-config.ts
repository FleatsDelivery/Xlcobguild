...
export const NOTIFICATION_TYPE_CONFIG: Record<string, TypeDisplayConfig> = {
  ...
  join_request:      { label: 'Join Request',        icon: 'UserPlus',    color: '#3b82f6' },
  join_request_accepted: { label: 'Request Accepted', icon: 'CheckCircle', color: '#10b981' },
  join_request_declined: { label: 'Request Declined', icon: 'XCircle',     color: '#ef4444' },
...
export const ACTIVITY_TYPE_CONFIG: Record<string, TypeDisplayConfig> = {
  ...
  join_request_sent:        { label: 'Join Request Sent',      icon: 'Send',         color: '#3b82f6' },
  join_request_accepted:    { label: 'Join Request Accepted',  icon: 'CheckCircle',  color: '#10b981' },
  join_request_declined:    { label: 'Join Request Declined',  icon: 'XCircle',      color: '#ef4444' },
  join_request_dismissed:   { label: 'Join Request Dismissed', icon: 'Trash2',       color: '#6b7280' },
